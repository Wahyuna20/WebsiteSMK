        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              <!-- /.card-header -->
              <div class="card-body">
                <a href="index.php?page=tambah_visimisi" class="btn btn-info" role="button" title="Tambah Data"><i class="fa fa-plus"></i> Tambah Visi Misi</a>
                ...
                ?>
                  ...
                  <td>
                    <a href="index.php?page=edit_visimisi&id=<?php echo $row['id'] ?>" class="btn btn-warning"><i class="fa fa-edit"></i>Edit</a>
                     |
                  <a href="index.php?page=hapus_visimisi&id=<?php echo $row['id'] ?>"class="btn btn-danger"><i class="fa fa-trash"></i>Hapus</a>
                   </td>
                </tr>
                <?php } ?>
                  </tfoot>
